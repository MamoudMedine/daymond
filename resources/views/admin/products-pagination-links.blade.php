@if ($paginator->hasPages())
    <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between">
           ...
           {{-- Previous Page Link END --}}
            ...
            <li class="relative inline-flex items-center px-4 py-2 text-sm font-medium
            ...
            active:text-gray-700 transition ease-in-out duration-150">1
            </li>
            <li class="relative inline-flex items-center px-4 py-2
            ...
            focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">2
            </li>
            @endforeach
            {{-- Next Page Link --}}
            <span>
