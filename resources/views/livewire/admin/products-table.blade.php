        ...
        <div class="w-full lg:w-5/6">
            <div class="bg-white shadow-md rounded my-6">
                <table class=" table-auto">
                    <thead>
                        <div class="p-3 bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            <x-form.search :placeholder="'Chercher'" class="bg-gray-200 w-full" />
                            <div>
                                <select wire:model="etat_id" class="input-form">
