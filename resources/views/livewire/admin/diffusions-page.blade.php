                                ...
                                <thead>
                                    <div class="p-3 flex justify-between flex-wrap bg-gray-200 text-gray-600 text-sm leading-normal">
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="flex-center-center">
                                                <select wire:model="type_diffusion_id" class="form-input">
                                                    <option value="">Trier par type</option>
                                                    @foreach ($type_diffusions as $type_diffusion)
                                                        <option value="{{$type_diffusion->id}}">
                                                            {{$type_diffusion->nom}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="flex-center-center">
                                                <a href="{{route('admin.diffusion.create')}}" class="btn-gradient ml-2">
                                                    Creer
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                        ...
                                        <th class="py-3 px-6 text-center">Disponibilite</th>
                                        <th class="py-3 px-6 text-center">Produit</th>
                                        <th class="py-3 px-6 text-center">Media</th>
                                        <th class="py-3 px-6 text-center">Type diffusion</th>
                                ...
                                <tbody class="text-gray-600 text-sm font-light">
                                    ...
                                    @foreach ($diffusions as $diffusion)
                                        <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                            ...
                                            <td class="py-3 px-6 text-center">
                                                @if ($diffusion->produit)
                                                    <a href="{{route('admin.product.details', $diffusion->produit->id)}}">
                                                        {{$diffusion->produit->nom}}
                                                    </a>
                                                @else
                                                    /
                                                @endif
                                            ...
                                            <td class="py-3 px-6 text-center">
                                                @if ($diffusion->media)
                                                    <a href="{{$diffusion->media->src}}" target="_blank">
                                            ...
                                            <td class="py-3 px-6 text-center">
                                                <div class="flex item-center justify-center">
                                                    ...
                                                    <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                        <a href="{{route('admin.diffusion.edit', $diffusion->id)}}">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                        <svg onclick="confirm('Etes vous sur de vouloir supprimer ?');Livewire.emit('deleteDiffusion', {{$diffusion->id}});" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
