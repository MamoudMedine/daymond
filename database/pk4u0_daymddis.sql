...
CREATE TABLE `cart_produit` (
  ...
  `quantite` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `montant` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `commandes` (
  ...
  `type_commande_id` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pays` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nom` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `indicatif` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `produits` (
  ...
  `prix_grossiste1` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prix_grossiste2` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `type_produit_id` int(10) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `is_confirmed` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- テーブルのインデックス `cart_produit`
--
ALTER TABLE `cart_produit`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cart_produit_cart_id_index` (`cart_id`),
  ADD KEY `cart_produit_produit_id_index` (`produit_id`);
...
ALTER TABLE `commandes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `commandes_type_commande_id_foreign` (`type_commande_id`),
...
ALTER TABLE `livraisons`
  ADD PRIMARY KEY (`id`),
  ADD KEY `livraisons_produit_id_index` (`produit_id`);
...
ALTER TABLE `produits`
  ...
  ADD KEY `produits_sous_categorie_id_index` (`sous_categorie_id`),
  ...
  ADD KEY `produits_type_produit_id_index` (`type_produit_id`),
...
--
-- テーブルのインデックス `sous_categories`
--
ALTER TABLE `sous_categories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sous_categories_categorie_id_index` (`categorie_id`);
...
ALTER TABLE `users`
  ...
  ADD KEY `users_adresse_id_index` (`adresse_id`);
...
--
-- テーブルのAUTO_INCREMENT `cart_produit`
--
ALTER TABLE `cart_produit`
...
--
-- テーブルのAUTO_INCREMENT `commande_produit`
--
ALTER TABLE `commande_produit`
...
--
-- テーブルのAUTO_INCREMENT `sous_categories`
--
ALTER TABLE `sous_categories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
-- テーブルのAUTO_INCREMENT `type_commande`
--
ALTER TABLE `type_commande`
...
--
-- テーブルのAUTO_INCREMENT `type_produits`
--
ALTER TABLE `type_produits`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `commandes`
  ADD CONSTRAINT `commandes_type_commande_id_foreign` FOREIGN KEY (`type_commande_id`) REFERENCES `type_commande` (`id`) ON DELETE CASCADE;
COMMIT;
